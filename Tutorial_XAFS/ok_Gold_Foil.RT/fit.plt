...
set size 0.5,0.9
#
set arrow 1 from km,-dk* 9 rto KM-km,0 lt 3 nohead
#
set label 1 'Au_bulk_300k.exa - AuRT' at screen 0.5,0.95 c font 'Times-Roman, 12' noenhanced
...
set label  9 'Res.' at KM-0.5,-dk*( 9+0.5) r font 'Times-Roman, 10'
set label 10 'R^2= 0.68E-01' at screen 0.45,0.9 c  font 'Times-Roman, 10'
set label 11 'F= 0.168E-06 ' at screen 0.65,0.9 c  font 'Times-Roman, 10'
#
#  PLOT 
#
pl [km:KM]'AuRT.fit' u 1:5 t'' w p ls 1,'' u 1:6 t'' w l ls 6,\
'' u 1:($7-dk* 9) t''w p ls 2,\
'' u 1:($8-dk* 9) t''w l ls 4,\
'' u 1:(-$8-dk* 9) t''w l ls 4,\
...
set label  9 'Res.' at RM-0.5,-dr*(10-0.5) r font 'Times-Roman, 12'
#
#
#  PLOT 
#
