...
set label 2 'Jump =-0.817E-03' at (Eo+.05),0.45  l font 'Times-Roman, 10'
set label 3 'WL   = 0.222    ' at (Eo+.05),0.35  l font 'Times-Roman, 10'
set label 4 'EWL   =  11920.08eV' at (Eo+.05),0.25  l font 'Times-Roman, 10'
...
set label 2 '******' at Kmax*.9-.5,dy c font 'Times-Roman, 9' rotate by 90
...
p 'Au_bulk_20k.exa'u 1:2 t'' w p ls 1,'' u 3:(0.0):(******/2) t'' w yerr ls 4,'Au_bulk_20k.bf' u 1:2 t'' w l ls 5
...
# 
##### ----------- -- Arrows and labels
set label 1 'd{/Symbol c}/dk * 0.479E+06 '  at Kmax*.9,.8 r font 'Times-Roman, 10'
set label 3 '{/Symbol s_c}: 0.17E+04   S/N:   0.82' at screen .5,screen 0.8 c font 'Times-Roman, 9' rotate by 90
